          ...
          <div key={pd.id} className="bg-white rounded-3xl shadow-card p-4">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="font-bold text-heading leading-tight">{doc.doctor_name}</p>
                {doc.specialty && (
                ...
                <div className="mt-2 space-y-1">
                  ...
                  {doc.online_reception_url && (
                    <a
                      href={doc.online_reception_url}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-1.5 text-xs font-medium text-[#3A3370]"
                    >
                      <ExternalLink size={12} />
                      <span>Online reception</span>
                    </a>
                  )}
                </div>
